...
public class LiftingSettings {
    ...
    public LiftingSettings(HyperRectangle init_rect, double reach_time, double initial_step_size, double max_rect_width_before_error, long max_runtime_milliseconds, int dynamics_index, UnsafeSet unsafe_set){
        ...
        if (reach_time > 0.0){
            ...
            throw new Error("invalid reach time");
        }
        ...
        if (initial_step_size > 0.0){
            ...
            throw new Error("invalid initial step size");
        }
        ...
        if (max_rect_width_before_error > 0.0){
            ...
            throw new Error("invalid maximum rectangle width before error");
        }
        ...
        if ((dynamics_index >= 0) && (dynamics_index <= 1)){
            ...
            throw new Error("Invalid dynamics index");
        }
