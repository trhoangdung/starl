package edu.illinois.mitra.starl.drreach.drreachDynamics;
...
public class Linear_Pendulum {
    ...
    public static final double[][] A = {{0, 1, 0, 0}, {0, -10.95, -2.75, 0.0043}, {0, 0, 0, 1}, {0, 24.92, 28.58, -0.044}}; // matrix A: 4 x 4
    public static final double[] B = {0, 1.94, 0, -4.44}; // matrix B transpose: 1 x 4
    public static final double[] K = {0.4072, 7.2373, 18.6269, 3.6725}; // matrix K: 1 x 4
    ...
    public double get_derivative_bounds(HyperRectangle rect, int faceIndex){
        ...
        if (dim >= 4){
            throw new Error("dimension index out of bounds in get_derivative_bounds");
        }
        else{
